                ...
                <form method="post" action="./index.php?page=edit">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" class="form-control"  value=" value="<?php echo $category->status; ?>"" name="status">Còn hàng
                            <input type="radio" class="form-control"  value=" value="<?php echo $category->status; ?>"" name="status">Hết hàng
                        </div>
